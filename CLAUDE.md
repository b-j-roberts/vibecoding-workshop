...
This repo contains all materials for a StarkWare PM Vibe Coding Workshop. The workshop teaches Product Managers to ship small MVPs using AI-assisted development (vibecoding).

- **What**: 3-session hands-on workshop (3h each), March 23-25 2026, 10:00-14:00 Israel time
...
- **Day 1**: Instructor does a 45min-1hr live demo of vibecoding a project end-to-end (with pre-run outputs to skip wait times), then participants scope their MVP and get a skeleton running
...
- `docs/TODO.md` — Preparation task list (ordered, with requirements)
- `demo/` — Live demo project (the project vibecoded during Day 1 kickoff)
...
- The demo project needs pre-run outputs at each step (git commits/branches) so the instructor can skip ahead during the live presentation
